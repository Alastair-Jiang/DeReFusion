...
用法：
  python scripts/analyze_volatility_regimes.py --csv dataset/GSPC-2016-2025.csv --tag GSPC
  python scripts/analyze_volatility_regimes.py --csv dataset/BTCUSD-2016-2025.csv --tag BTCUSD
...
def main():
    ...
    with open(os.path.join(repo, f"volatility_stratification_{suffix}.txt"), "w", encoding="utf-8") as f:
        f.write(txt)
    with open(os.path.join(repo, f"volatility_stratification_{suffix}.json"), "w", encoding="utf-8") as f:
